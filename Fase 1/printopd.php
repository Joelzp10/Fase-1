...
<form class="" action="" method="post" id="upform">
  ...
  <table height="500" width="500">
    ...
    <tr>
      ...
      <td width="250"><strong>Q <?php echo $row["medi_charge"]; ?></strong></td>
    </tr>
    <tr>
      <td width="200"><strong>Cobros por doctores : </strong></td>
      <td width="250"><strong>Q <?php echo $row["doc_charge"]; ?></strong></td>
    <tr>
      <td ><strong>Cargo por servicios : </strong></td>
      <td ><strong>Q <?php echo $row["hos_charge"]; ?></strong></td>
    </tr>
    <tr>
      <td ><strong>Cobro total : </strong></td>
      <td ><strong>Q <?php echo $row["total_charge"]; ?></strong></td>
    </tr>
  </table>
<br>
