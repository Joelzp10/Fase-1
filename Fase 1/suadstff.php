...
<h3 style="font-family:calibri;" class="text-center">Actualizar la información de los miembros del personal</h3></div>
</div>
</div>
</div>
...
<div class="row">
<div class="">
<h4 style="font-family:calibri;" class="text-center">Habilitar campos usando el menú desplegable de campos activos</h4>
<div class="container">
<div class="row">
<div class="col-md-4 col-md-push-4">
<ul class="nav  nav-justified" style="background-color:#FFF;">
<li style="font-family:calibri; font-size:16px;"><a href="supadminopsm.php">Regresar</a></ul>
</div>
</div>
</div>
<br />
...
<form class="" action="" method="post" id="upform">
  ...
  <dt style="font-size:12px;"><strong>Número de registro:</strong> </dt>
  <dd style="font-size:12px;"><?php echo $row["staffID"]; ?></dd>

  <dt style="font-size:12px;"><strong>Nombre del personal: </strong> </dt>
  ...
  <dt style="font-size:12px;"><strong>Apellido del personal: </strong> </dt>
  ...
  <dt style="font-size:12px;"><strong>Género del personal: </strong></dt>
  <dd style="font-size:12px;">
  <select name="gen"  id="gen"  style="margin:5px" class="form-control" placeholder="Seleccione el genero">
      <option value="<?php echo $row["smgender"]; ?>"><?php echo $row["smgender"]; ?></option>
      <option value="Masculino">Masculino</option>
      <option value="Femenino">Femenino</option></dd>
  </select>
  <dt style="font-size:12px;"><strong>Tipo de Personal: </strong></dt></dt>
  <dd style="font-size:12px;">
  ...
  <dt style="font-size:12px;"><strong>Horario de Trabajo: </strong></dt></dt>
  <dd style="font-size:12px;">
  ...
  <option value="Mañana">Horario Matutino</option>
  <option value="Tarde">Horario Vespertino</option>
  <option value="Full">Full</option>
  </select></dd>

  <dt style="font-size:12px;"><strong>Dirección del Personal: </strong></dt>
  ...
  <dt style="font-size:12px;"><strong>Numero Móvil del Personal: </strong>
...
<dl>
  ...
  <center>
<button disabled id="Button" class="btn btn-primary" name=submit type="submit">Actualizar</button>
</center>
  </ul>
  </div>
</form>
