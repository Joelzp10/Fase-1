...
<div class="alert alert-danger col-md-4 col-md-offset-4 col-xs-12 text-center">Este formulario de registro de usuario crea solo Cuentas de resepción, las Cuentas de resepción solo pueden inserciones.</div></div>
<div class="container">
<div class="row">
...
<tr><td colspan="2" style="padding:5px;">
  <input onkeyup="chechemfn(this.value)" name="uemail"  required="required" style="border-radius:0px" type="text" class="form-control" placeholder="Correo Electronico"><div id="msge"></div>
  <center><script type="text/javascript">
...
document.write('<?php echo $pwm; ?>');</script> </center> </td></tr>
  <tr><td colspan="2" style="padding:5px;"><center><button name="register" class="btn btn-primary">Enviar</button></center></td></tr>
