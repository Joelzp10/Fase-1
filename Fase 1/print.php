...
<h1 class="text-center ">Clinica Privada<br /><small style="font-size:20px">Factura de Paciente</small></h1></div>
</div>
</div>
<center>
<form class="" action="" method="post" id="upform">
  ...
  <table height="500" width="500">
    ...
    <tr>
      ...
      <td width="250"><strong>Q <?php echo $row["price_of_med"]; ?></strong></td>
    </tr>
    <tr>
      <td width="200"><strong>Precio por doctores : </strong></td>
      <td width="250"><strong>Q <?php echo $row["price_of_doc"]; ?></strong></td>
    </tr>
      <td ><strong>Cuenta de días internado</strong></td>
      <td ><strong><?php echo $row["day_count"]; ?></strong></td>
    </tr>
    <tr>
      <td ><strong>Precio por Habitación : </strong></td>
      <td ><strong>Q <?php echo $row["price_of_doc"]; ?></strong></td>
    </tr>
    <tr>
      <td ><strong>Cobros de Servicio : </strong></td>
      <td ><strong>Q <?php echo $row["ser_char"]; ?></strong></td>
    </tr>
    <tr>
      <td ><strong>Precio total : </strong></td>
      <td ><strong>Q <?php echo $row["totl"]; ?></strong></td>
    </tr>
  </table>
<br>
