...
<ul class="nav  nav-justified" style="background-color:#FFF;">
  <li  style="font-family:calibri; font-size:16px;"><a style="color:#000" href="supadmopt.php"><strong>Opciones de Super Admin</strong></a></li>
...
<div class="row col-md-8 col-md-offset-2 col-xs-12">
  <ul class="nav  nav-justified" style="background-color:#FFF;">
    <li  style="font-family:calibri; font-size:16px;"><a style="color:#000" href="basiadminopts.php"><strong>insertar Administración básica</strong></a></li>
    <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="deletesbsad.php"><strong>Eliminar administración básica</strong></a></li>
  </ul>
<hr>
</div></div>
...
<th><strong>Reg.No de administración básica</strong></th>
<th><strong>Nombre completo del administrador básico</strong></th>
<th><strong>Nombre de usuario de administrador básico</strong></th>
<th><strong>Correo electrónico de administrador básico</strong></th>
<th><strong>Fecha de creación del administrador básico</strong></th>
<th></th>
<th></th>
</tr>
</thead>
