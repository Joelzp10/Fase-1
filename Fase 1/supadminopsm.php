...
<h3 style="font-family:calibri;" class="text-center">Información del Personal</h3></div>
</div>
</div>
</div>
<div class="container">
...
<form class="" action="" method="post" id="upform">
  ...
  <dt style="font-size:12px;"><strong>Registro # del Paciente :</strong> </dt>
  <dd style="font-size:12px;"><?php echo $row["staffID"]; ?></dd>
<br>
  <dt style="font-size:12px;"><strong>Nombre del Paciente : </strong> </dt>
  ...
  <select  id="gen" disabled style="margin:5px" name="gender" required="required"  class="form-control" placeholder="Seleccione su género">
      <option  value="<?php echo $row["smgender"]; ?>"><?php echo $row["smgender"]; ?></option>
      <option value="Male">Masculino</option>
      <option value="Female">Femenino</option></select></dd>

  <dt style="font-size:12px;"><strong>Tipo miembro del personal: </strong></dt>
      <dd style="font-size:12px;">
      <select  id="gen" disabled style="margin:5px" name="gender" required="required"  class="form-control" placeholder="Seleccione su género">
          <option  value="<?php echo $row["smtype"]; ?>"><?php echo $row["smtype"]; ?></option>
          <option value="Doctor">Doctor</option>
          <option value="Nurse">Enfermera</option>
          <option value="Other">Otro</option></select></dd>

          <dt style="font-size:12px;"><strong>Jornada Laboral: </strong></dt>
          <dd style="font-size:12px;">
          <select  id="gen" disabled style="margin:5px" name="gender" required="required"  class="form-control" placeholder="Seleccione su género">
              <option  value="<?php echo $row["smwoti"]; ?>"><?php echo $row["smwoti"]; ?></option>
              <option value="Mañana">Hora de la mañana</option>
              <option value="Noche">Horario Nocturno</option>
              <option value="Tiempo Completo">Tiempo completo</option></select></dd>
  ...
  <input name="ptel" id="tel" disabled type="text" class="form-control" value="<?php echo $row["smtel"]; ?>" placeholder="Nombre del usuario" aria-describedby="basic-addon1 ">
  </dd>
  ...
  <dt style="font-size:12px;"><strong>Fecha y Hora Ingresadas: </strong></dt>
  ...
  <dt style="font-size:12px;"><strong>Actualización por: </strong></dt>
  ...
  <dt style="font-size:12px;"><strong>Fecha y Horas actualizadas: </strong></dt>
...
<dl>
  ...
  <li style="background-color:rgba(255, 255, 255, 0.3);"><a href="suadstff.php?id=<?php echo $row["staffID"]; ?>" style="colour:#000">Actualizar</a></li>
  <li style="background-color:rgba(255, 255, 255, 0.3);"><a href="deletestf.php?id=<?php echo $row["staffID"]; ?>" style="colour:#000">Eliminar</a></li>
  </ul>
  </div>
</form>
<?php
