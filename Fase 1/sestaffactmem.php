...
<h4 style=" color:">
No. de reg. del paciente : <?php echo $row["staffID"]; ?><br />
Nombre del paciente : <?php echo $row["smfname"]; ?> <?php echo $row["smlname"]; ?><br />
</h4>
...
<dt style="font-size:12px;"><strong>Tiempo de trabajo del miembro: </strong></dt></dt>
...
<li style="background-color:rgba(255, 255, 255, 0.3);"><a  href="supadmst.php" name="ad">Modificaciones de detalles del personal</a></li>
</ul>
</div>
<?php }} ?>
</div>
