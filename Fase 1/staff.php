...
<h3 style="font-family:calibri;" class="text-center">Registro de Miembro del Personal</h3></div>
<br />
...
<form id="sreg" name="sreg" action="" method="post">
  ...
  <tr>
    <td colspan="2" style="padding:5px"><div class="input-group col-md-12 col-xs-12 "> <span style="border-radius:0px; width:10px" class="input-group-addon" id="basic-addon1">+502</span><input pattern="\d{8,8}"  maxlength="8" title="Número de teléfono no válido, el número de caracteres debe ser de 8 digítos" name="tel" required  type="tel" class="form-control" placeholder="Número de Contacto" style="border-radius:0px"></div><script type="text/javascript">
...
('<?php echo $emlduperr; ?>');</script></td>
  ...
  <tr>
    ...
    <option value="">Perfil del empleado</option>
