...
<div class="container">
<div class="row">
<div class="col-md-4 col-md-push-4 col-xs-12 alert alert-success text-center">Los Pacientes registrados en este apartado están conectados directamente con el departamento de pacientes de la Clinica San Franciscos.</div>
</div>
</div>
...
<?php $count++; } ?>
  ...
  <tr>
    <td colspan="2" style="padding:5px"><div class="input-group col-md-12 col-xs-12 "> <span style="border-radius:0px; width:10px" class="input-group-addon" id="basic-addon1">+502</span><input  pattern="\d{9,9}"  maxlength="8" title="Número de teléfono no válido, el número de caracteres debe ser 8" name="tel" required  type="number" class="form-control" placeholder="Número de contacto" style="border-radius:0px"></div><script type="text/javascript">
...
document.write('<?php echo $gestwterr; ?>');
  ...
  <tr>
  <td colspan="2" style="padding:5px"><div align="center"><button onclick="valie();"   name="submit" type="submit" class="btn btn-primary" value="SUBMIT">Enviar</button></div></td>
    </tr>
...
<script type="text/javascript">
  var x = "Basico Administrador"; 
  var y = "Super Administrador";
