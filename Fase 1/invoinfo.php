...
<th style="text-align: center"><strong>Número de Factura</strong></th>
<th style="text-align: center"><strong>Fecha</strong></th>
<th style="text-align: center"><strong>No Registro de Paciente</strong></th>
<th style="text-align: center"><strong>Nombre de Paciente</strong></th>
<th style="text-align: center"><strong>Cargos del doctor</strong></th>
<th style="text-align: center"><strong>Cargos de Medicina</strong></th>
<th style="text-align: center"><strong>Cargos del Hospital</strong></th>
<th style="text-align: center"><strong>Cargo Total</strong></th>
</tr>
</thead>
<tbody>
<?php
...
<tr>
    ...
    <td align="center">Q <?php echo $row["doc_charge"]; ?> </td>
    <td align="center">Q <?php echo $row["medi_charge"]; ?> </td>
    <td align="center">Q <?php echo $row["hos_charge"]; ?> </td>
    <td align="center">Q <?php echo $row["total_charge"]; ?></td>
