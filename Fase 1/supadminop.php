...
<h4 style="font-family:calibri;" class="text-center alert alert-danger">Pulsa el botón de "Búsqueda" para ver todos los detalles</h4>
</div>
</div>
</div>
<div class="container">
<table style="background-color: rgba(222,444,444,0.0);" class="table table-responsive" width="500" border="0"><form action="" method="post">
  <tr>
    <td><input style="font-size:12px" type="text" name="searvalu" class="form-control" placeholder="Ingresa número de registro / Número telefonico / Correo electrónico / Grupo de sangre" /></td>
  </tr><tr align="center">
...
<form class="" action="" method="post" id="upform">
  ...
  <dd style="font-size:12px;">
  <select id="bog" disabled style="margin:5px" name="bg" required="required"  class="form-control" placeholder="Seleccione su tipo de personal">
  ...
  <dd style="font-size:12px;"><?php echo $row["Pet_opdid"]; ?><br> <a target="_blank" href="admitdf.php?id= <?php echo $row["Pet_opdid"]; ?>" name="ad"> Más Información </a></dd>
