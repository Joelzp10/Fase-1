...
<div class="col-md-4 col-md-push-2  col-xs-12 ">
	...
	<div style="font-size :18px; border-style: none  none none dotted; border-width: 2px; border-color: rgba(0, 0, 0, 0.2); height: 390px;text-align: justify;" class="col-md-4 col-md-push-2  col-xs-12 "><br>Bienvenido al formulario de inicio de sesión del sistema principal para ingresar al sistema debe colocar los datos de inicio de sesión de administrador Super y Básico.
<br>
	<br>Ingrese los datos de inicio de sesión proporcionados por la Administración de Clinica San Francisco.</div>
	</div>
	<br><br>
</div>
</div>
    ...
    <div class="row">
		...
		<p>Desarrollo Web 2022 Grupo 7</p>
        </div>
    </div>
    </div>
	</footer>
